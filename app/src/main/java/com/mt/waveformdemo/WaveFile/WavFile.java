package com.mt.waveformdemo.WaveFile;// Wav file IO class
// A.Greensted
...
public class WavFile {
    ...
    public static WavFile openWavFile(Uri uri, Context context) throws IOException, WavFileException {
        // Instantiate new Wavfile and store the file reference
        WavFile wavFile = new WavFile();
        ...
        // Create a new file input stream for reading file data
        wavFile.iStream = (FileInputStream) context.getContentResolver().openInputStream(uri);
